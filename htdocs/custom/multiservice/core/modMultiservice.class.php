 ...
 */
class modMultiservice extends DolibarrModules {
    /**
     * 
     */
    private const SGM_MODULE_NUMBER = 1000;

    /**
     * 
     */
    private const SGM_MODULE_POSITION = 10;
	...
	public function __construct($db) {
		...
		$this->db = $db;
		$this->numero = $SGM_MODULE_NUMBER;

		$this->family = "sgm";
		$this->module_position = $SGM_MODULE_POSITION;
        
        // Module label (no space allowed), used if translation string 'ModuleXXXName' not found (where XXX is value of numeric property 'numero' of module)
		$this->name = preg_replace('/^mod/i', '', get_class($this));
		$this->description = "Sistema de Gestão Multiservice";

		// Possible values for version are: 'development', 'experimental', 'dolibarr' or version
		$this->version = 'dolibarr';

		$this->const_name = 'MAIN_MODULE_'.strtoupper($this->name);
		$this->config_page_url = array("multiservice.php@societe");
        
        // Name of image file used for this module.
		$this->picto = 'multiservice';

		// Data directories to create when module is enabled
		$this->dirs = array("/multiservice/temp");
    ...
    //Setup and Definition Functions
    ...
    private function defineConstants() {
		...
		$this->const[$r][$s] = "SGM_MODULE_CONSTANT";
		$this->const[$r][$s++] = "chaine";
		$this->const[$r][$s++] = "mod_codeclient_monkey";
		$this->const[$r][$s++] = 'Module to control other SGM modules';
        $this->const[$r][$s++] = 0;
    ...
    private function defineBoxes() {
		...
		$this->boxes[$r][$s++] = "box_clients.php";
    ...
    private function definePermissions() {
        $this->rights = array();
		$this->rights_class = 'multiservice';
        $r = 0;
        $s = 0;

		$this->rights[$r][$s] = 121; // id de la permission
		$this->rights[$r][$s++] = 'Read third parties'; // libelle de la permission
		$this->rights[$r][$s++] = 'r'; // type de la permission (deprecie a ce jour)
		$this->rights[$r][$s++] = 0; // La permission est-elle une permission par defaut
        $this->rights[$r][$s++] = 'lire';
